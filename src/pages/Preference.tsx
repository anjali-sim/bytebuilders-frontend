          ...
          <div className="space-x-2 flex flex-wrap">
            {options.diet.map((option, index) => (
              <Button
                key={index}
                variant={
                  preferences.diet.includes(index.toString()) ? 'solid' : 'outline'
                }
                className={`m-1 ${preferences.diet.includes(index.toString()) ? 'bg-primary text-white' : ''}`}
                onClick={() => handleOptionClick('diet', index)}
              >
                {option}
              </Button>
            ))}
          ...
          <div className="space-x-2 flex flex-wrap">
            {options.allergies.map((option, index) => (
              <Button
                key={index}
                variant={
                  preferences.allergies.includes(index.toString()) ? 'solid' : 'outline'
                }
                className={`m-1 ${preferences.allergies.includes(index.toString()) ? 'bg-primary text-white' : ''}`}
                onClick={() => handleOptionClick('allergies', index)}
              >
                {option}
              </Button>
            ))}
          ...
          <div className="space-x-2 flex flex-wrap">
            {options.cuisines.map((option, index) => (
              <Button
                key={index}
                variant={
                  preferences.cuisines.includes(index.toString()) ? 'solid' : 'outline'
                }
                className={`m-1 ${preferences.cuisines.includes(index.toString()) ? 'bg-primary text-white' : ''}`}
                onClick={() => handleOptionClick('cuisines', index)}
              >
                {option}
              </Button>
            ))}
